...
# env = gym.make("fei-v0")  # 自定义的环境，与自带的racetrack环境相同，目前在学习如何自定义自己的环境
# env = gym.make("racetrack-v0")  #
env = gym.make("highway-v0")  # 不同的环境的configuration里的action各种都不一样！！！！要自己改的，比如highway跟车多，racetrack转弯多
env.configure(
    {
        "observation": {
            "type": "OccupancyGrid",
...
print(rewards)
plt.plot(rewards)
plt.savefig('highway/higway_DDPG/reward.jpg')